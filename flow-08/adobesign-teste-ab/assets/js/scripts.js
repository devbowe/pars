...
$btnSubmit.addEventListener("click", (e) => {
    if (nome.value.trim() === "") {
        ...
        e.preventDefault();
    } else if (docs_transacionados.value === "nulo") {
        showErrorPopUp(
            "Informe o número de transações/mês",
            docs_transacionados
        );
        // showBorderError(docs_transacionados);
...
const focusInput = [nome, email, telefone, empresa, n_funcionaciorios];
