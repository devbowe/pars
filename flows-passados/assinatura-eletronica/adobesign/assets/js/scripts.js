window.onload = function () {
    ...
    $("input[name=firstname]").after(
        $(
            '<input type="hidden" name="url_pagina" value="' +
                location.href +
                '" />'
        )
    );
...
$("#send").click(function () {
    ...
    var docs_transacionados = $("#docs_transacionados");
    ...
    if (!nome.val()) {
        ...
        Swal.fire({
            icon: "warning",
            text: "Informe o número de documentos transacionados",
            timer: 2000,
            onAfterClose: () => {
                docs_transacionados.focus();
            },
        });
    } else if (usuarios.val() == "nulo") {
        Swal.fire({
            icon: "warning",
            text: "Informe o número de usuários",
            timer: 2000,
            onAfterClose: () => {
                usuarios.focus();
            },
